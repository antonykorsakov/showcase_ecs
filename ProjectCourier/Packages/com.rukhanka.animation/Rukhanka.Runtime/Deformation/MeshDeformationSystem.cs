...
public partial class MeshDeformationSystem: SystemBase
{
	...
	SparseUploader frameSkinMatricesUploader;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	protected override void OnCreate()
	{
		...
		frameSkinMatricesUploader = new (null);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	protected override void OnDestroy()
	{
		...
		frameSkinMatricesUploader.Dispose();
	}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	protected override void OnUpdate()
	{
		...
		frameSkinMatricesUploader.EndAndCommit(skinMatrixThreadedUploader);
		...
		//	Need to inject GPU animation system here, for GPU animated entities skin matrix computation directly to skin matrix frame GPU buffer
		...
		frameSkinMatricesUploader.FrameCleanup();
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	(JobHandle, ThreadedSparseUploader) CopySkinMatricesToGPUBuffer(in DeformationRuntimeData drd, JobHandle dependsOn)
	{
		...
		frameSkinMatricesUploader.ReplaceBuffer(frameSkinMatricesBuffer);
		...
		var gpuSkinMatrixThreadedUploader = frameSkinMatricesUploader.Begin(skinMatrixDataSize, maxDataUploadSize, numEntities);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	#if RUKHANKA_HALF_DEFORMED_DATA
		meshDeformationSystemCS.EnableKeyword("RUKHANKA_HALF_DEFORMED_DATA");
	#else
		meshDeformationSystemCS.DisableKeyword("RUKHANKA_HALF_DEFORMED_DATA");
	#endif
