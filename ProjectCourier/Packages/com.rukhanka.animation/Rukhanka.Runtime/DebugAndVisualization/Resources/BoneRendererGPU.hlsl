...
#include "../../../Rukhanka.DebugDrawer/Resources/RukhankaBoneRenderer.hlsl"
#include "../../GPUAnimationEngine/Resources/GPUStructures.hlsl"
...
VertexToPixel VSGPUAnimator(VertexInput i)
{
    ...
    worldPos = BoneTransform::Transform(entityPose, worldPos);
