...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public void Execute(int globalBoneIndex)
	{
		...
		var refPosWeight = CalculateFinalLayerWeights(layerWeights, animationsToProcess, rigBoneIndex, rb.humanBodyPart);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public static float CalculateFinalLayerWeights(in Span<float> layerWeights, in DynamicBuffer<AnimationToProcessComponent> atp, int boneIndex, AvatarMaskBodyPart humanAvatarMaskBodyPart)
	{
		var layerIndex = -1;
		var w = 1.0f;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	)
	{
		...
		var trackIndex = acb.clipTracks.trackGroupPHT.Query(boneHash);
...
partial struct ProcessAnimatorParameterCurveJob: IJobEntity
{
	unsafe void Execute(in DynamicBuffer<AnimationToProcessComponent> animationsToProcess, ref DynamicBuffer<AnimatorControllerParameterComponent> acpc)
	{
		...
		//	Animations must be ordered by layer index
		Span<float> layerWeights = stackalloc float[animationsToProcess[^1].layerIndex + 1];
		ComputeBoneAnimationJob.CalculateFinalLayerWeights(layerWeights, animationsToProcess, -1, (AvatarMaskBodyPart)(-1));
