...
public partial class GPUAnimationSystem
{
	...
	readonly int ShaderID_boneClipsBuffer = Shader.PropertyToID("boneClipsBuffer");
	readonly int ShaderID_animationCurvesBuffer = Shader.PropertyToID("animationCurvesBuffer");
	readonly int ShaderID_keyFramesBuffer = Shader.PropertyToID("keyFramesBuffer");
