...
void GPUAttachmentMeshMover_float(in float3 vertex, in float3 normal, in float3 tangent, out float3 animatedVertex, out float3 animatedNormal, out float3 animatedTangent)
{
    ...
    float3 transformedPos = BoneTransform::Transform(bt, animatedVertex);
    ...
    animatedNormal = Quaternion::Rotate(bt.rot, animatedNormal);
    ...
    animatedTangent = Quaternion::Rotate(bt.rot, animatedTangent);
